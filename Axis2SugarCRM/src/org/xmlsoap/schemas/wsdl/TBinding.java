 ...
 */
        ...
        public  class TBinding extends org.xmlsoap.schemas.wsdl.TExtensibleDocumented
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                                    ...
                                    protected org.xmlsoap.schemas.wsdl.TBindingOperation[] localOperation ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           * @return org.xmlsoap.schemas.wsdl.TBindingOperation[]
                           */
                           public  org.xmlsoap.schemas.wsdl.TBindingOperation[] getOperation(){
                               ...
                               */
                              protected void validateOperation(org.xmlsoap.schemas.wsdl.TBindingOperation[] param){
                              ...
                              */
                              public void setOperation(org.xmlsoap.schemas.wsdl.TBindingOperation[] param){
                             ...
                             * @param param org.xmlsoap.schemas.wsdl.TBindingOperation
                             */
                             public void addOperation(org.xmlsoap.schemas.wsdl.TBindingOperation param){
                                   if (localOperation == null){
                                   localOperation = new org.xmlsoap.schemas.wsdl.TBindingOperation[]{};
                                   }
                            ...
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localOperation);
                               list.add(param);
                               this.localOperation =
                             (org.xmlsoap.schemas.wsdl.TBindingOperation[])list.toArray(
                            new org.xmlsoap.schemas.wsdl.TBindingOperation[list.size()]);
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       TBinding.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                                       ...
                                       if (localOperation!=null){
                                            for (int i = 0;i < localOperation.length;i++){
                                                if (localOperation[i] != null){
                                                 localOperation[i].serialize(new javax.xml.namespace.QName("http://schemas.xmlsoap.org/wsdl/","operation"),
                                                           factory,xmlWriter);
                                                } else {
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("http://schemas.xmlsoap.org/wsdl/","tBinding"));
                 if (localDocumentationTracker){
    ...
    public static class Factory{
        ...
        */
        public static TBinding parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            TBinding object =
                new TBinding();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"tBinding".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (TBinding)com.sugarcrm.www.sugarcrm.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list3 = new java.util.ArrayList();
                                   ...
                                   if (reader.isStartElement()){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://schemas.xmlsoap.org/wsdl/","operation").equals(reader.getName())){
                                
                                    
                                    
                                    // Process the array and step past its final element's end.
                                    list3.add(org.xmlsoap.schemas.wsdl.TBindingOperation.Factory.parse(reader));
                                                        ...
                                                        while(!loopDone3){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("http://schemas.xmlsoap.org/wsdl/","operation").equals(reader.getName())){
                                                                    list3.add(org.xmlsoap.schemas.wsdl.TBindingOperation.Factory.parse(reader));
                                                        ...
                                                        object.setOperation((org.xmlsoap.schemas.wsdl.TBindingOperation[])
                                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                                org.xmlsoap.schemas.wsdl.TBindingOperation.class,
                                                                list3));
