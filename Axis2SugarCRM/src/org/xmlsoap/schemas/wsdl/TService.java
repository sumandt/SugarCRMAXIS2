 ...
 */
        ...
        public  class TService extends org.xmlsoap.schemas.wsdl.TExtensibleDocumented
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                                    ...
                                    protected org.xmlsoap.schemas.wsdl.TPort[] localPort ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           * @return org.xmlsoap.schemas.wsdl.TPort[]
                           */
                           public  org.xmlsoap.schemas.wsdl.TPort[] getPort(){
                               ...
                               */
                              protected void validatePort(org.xmlsoap.schemas.wsdl.TPort[] param){
                              ...
                              * @param param Port
                              */
                              public void setPort(org.xmlsoap.schemas.wsdl.TPort[] param){
                             ...
                             * @param param org.xmlsoap.schemas.wsdl.TPort
                             */
                             public void addPort(org.xmlsoap.schemas.wsdl.TPort param){
                                   if (localPort == null){
                                   localPort = new org.xmlsoap.schemas.wsdl.TPort[]{};
                                   }
                            ...
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localPort);
                               list.add(param);
                               this.localPort =
                             (org.xmlsoap.schemas.wsdl.TPort[])list.toArray(
                            new org.xmlsoap.schemas.wsdl.TPort[list.size()]);
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       TService.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                                ...
                                throw new org.apache.axis2.databinding.ADBException("extraElement cannot be null!!");
                                       ...
                                       if (localPort!=null){
                                            for (int i = 0;i < localPort.length;i++){
                                                if (localPort[i] != null){
                                                 localPort[i].serialize(new javax.xml.namespace.QName("http://schemas.xmlsoap.org/wsdl/","port"),
                                                           factory,xmlWriter);
                                                } else {
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("http://schemas.xmlsoap.org/wsdl/","tService"));
                 if (localDocumentationTracker){
    ...
    public static class Factory{
        ...
        */
        public static TService parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            TService object =
                new TService();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"tService".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (TService)com.sugarcrm.www.sugarcrm.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list3 = new java.util.ArrayList();
                                   ...
                                   if (reader.isStartElement()){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://schemas.xmlsoap.org/wsdl/","port").equals(reader.getName())){
                                
                                    
                                    
                                    // Process the array and step past its final element's end.
                                    list3.add(org.xmlsoap.schemas.wsdl.TPort.Factory.parse(reader));
                                                        ...
                                                        while(!loopDone3){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("http://schemas.xmlsoap.org/wsdl/","port").equals(reader.getName())){
                                                                    list3.add(org.xmlsoap.schemas.wsdl.TPort.Factory.parse(reader));
                                                        ...
                                                        object.setPort((org.xmlsoap.schemas.wsdl.TPort[])
                                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                                org.xmlsoap.schemas.wsdl.TPort.class,
                                                                list3));
